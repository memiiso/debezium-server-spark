...
public class FileOutputCommitterV2 extends FileOutputCommitter {
  ...
  public static final String FILEOUTPUTCOMMITTER_PENDING_DIR_NAME =
      "mapreduce.fileoutputcommitter.pending.dir";
  private static final Logger LOG =
      LoggerFactory.getLogger(FileOutputCommitterV2.class);
  /**
   ...
   * @throws IOException
   */
  public FileOutputCommitterV2(Path outputPath,
